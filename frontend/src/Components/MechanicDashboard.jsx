...
const MechanicDashboard = () => {
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:5000/mechanic/details', {
    ...
    const handleUpdateSubmit = (e) => {
        ...
        axios.put(`http://localhost:5000/mechanic/update/${userId}`, editForm, {
            headers: {
    ...
    const handleApprove = () => {
        ...
        axios.put(`http://localhost:5000/service-request/approve/${selectedRequest._id}`, {}, {
            headers: { Authorization: `Bearer ${token}` },
        })
            .then((response) => {
    ...
    const handleReject = () => {
        ...
        axios.put(`http://localhost:5000/service-request/reject/${selectedRequest._id}`, {}, {
            headers: { Authorization: `Bearer ${token}` },
        })
            .then((response) => {
                console.log('Response:', response);
    ...
    const handleToggle = () => {
        ...
        axios.put('http://localhost:5000/mechanic/update-status', { isAvailable: newStatus }, {
            headers: { Authorization: `Bearer ${token}` },
        })
            .then((res) => {
